...
<div class="content-wrapper">
  ...
  <form method="POST" onsubmit="return confirm('are you sure with your decision? click OK to continue');" action="adminapproveprocess.php">
    <div class="form-group">
      ...
      <input type="hidden" id="fbid" name="fbid" value="<?php echo $rows['b_id'];?>">
      <button  type="submit" class="btn btn-primary" >Submit</button>
       <a href="admin.php" class="btn btn-secondary float-right">Back</a>
...
<div class="col-sm-6">
  ...
  <table class="table table-striped">
    <tbody>
      <tr><td>Customer IC: <?php echo $rows['c_ic'];?></td></tr>
...
<div class="row mb-2">
  ...
  <table class="table table-striped">
    <tbody>
      ...
      <tr><td>Type: <?php echo $rows['v_type'];?></td></tr>
      <tr><td>Year: <?php echo $rows['v_year'];?></td></tr>
    </tbody>
  </table>
</div>
